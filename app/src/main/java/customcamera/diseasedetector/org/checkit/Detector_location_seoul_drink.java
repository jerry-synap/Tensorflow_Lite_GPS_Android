...
public class Detector_location_seoul_drink extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
/*private void galleryAddPic() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences wmbPreference = PreferenceManager.getDefaultSharedPreferences(Detector_location_seoul_drink.this);
...
*/
        ...
        cameraView.addCameraKitListener(new CameraKitEventListener() {
            ...
            public void onImage(CameraKitImage cameraKitImage) {
                ...
                if(results.toString().contains("icecream")) {
                ...
                if(results.toString().contains("potbingsoo")) {
                ...
                if(results.toString().contains("soju1")) {
                ...
                if(results.toString().contains("beer1")) {
                ...
                if(results.toString().contains("chungha")) {
                ...
                if(results.toString().contains("mehwasoo")) {
                ...
                if(results.toString().contains("bokboonja")) {
                ...
                if(results.toString().contains("makgulri")) {
                ...
                if(results.toString().contains("juice1")) {
                ...
                if(results.toString().contains("coffee1")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("beer2")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("coke")) {
                ...
                if(results.toString().contains("Sprite")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("sake1")) {
                ...
                if(results.toString().contains("sake2")) {
                ...
                if(results.toString().contains("beer3")) {
                ...
                if(results.toString().contains("tea1")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("sansachoon")) {
                ...
                if(results.toString().contains("notrelative1")) {
                    Toast.makeText(Detector_location_seoul_drink.this, R.string.Toast7, Toast.LENGTH_LONG).show();
                ...
                if(results.toString().contains("beksejoo")) {
                ...
                if(results.toString().contains("hwanta")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("coolpis")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("Budweiser")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("Hoegaarden")) {
                ...
                if(results.toString().contains("Heineken")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("cake1")) {
                ...
                if(results.toString().contains("hite")) {
                ...
                if(results.toString().contains("Sapporo")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("coffee2")) {
                ...
                if(results.toString().contains("coffee3")) {
                ...
                if(results.toString().contains("coffee4")) {
                    textviewsystom.setVisibility(View.VISIBLE);
                ...
                if(results.toString().contains("fish9")) {
        ...
        btnDetectObject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Detector_location_seoul_drink.this, R.string.Toast8, Toast.LENGTH_SHORT).show();
    ...
    private void openFileChooser() {
        ...
        Toast.makeText(Detector_location_seoul_drink.this, R.string.Toast9, Toast.LENGTH_LONG).show();
            ...
            mUploadTask = fileReferendce.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(Detector_location_seoul_drink.this, "Upload successful", Toast.LENGTH_LONG).show();
                            CloseKeyboard();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Detector_location_seoul_drink.this, e.getMessage(), Toast.LENGTH_SHORT).show();
